    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo esc_html( get_option( "gmt_offset" ) ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php echo esc_html( ini_get( "date.timezone" ) ); ?></td>
        </tr>
        <tr>
          <th>time()</th>
        ...
        <tr>
          ...
          <td><?php echo esc_html( date( "Y-m-d H:i:s" , time() + MywpHelper::get_gmt_offset_seconds() ) ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <th>strtotime( "now" )</th>
          <td><?php echo esc_html( strtotime( "now" ) ); ?></td>
        </tr>
        <tr>
          <th>date( "Y-m-d H:i:s" , strtotime( "now" ) )</th>
          <td><?php echo esc_html( date( "Y-m-d H:i:s" , strtotime( "now" ) ) ); ?></td>
        </tr>
        <tr>
          <th>current_time( "timestamp" )</th>
          <td><?php echo esc_html( current_time( "timestamp" ) ); ?></td>
        </tr>
        <tr>
          <th>current_time( "timestamp" , true )</th>
          <td><?php echo esc_html( current_time( "timestamp" , true ) ); ?></td>
        </tr>
        <tr>
          <th>date( "Y-m-d H:i:s" , current_time( "timestamp" ) )</th>
          <td><?php echo esc_html( date( "Y-m-d H:i:s" , current_time( "timestamp" ) ) ); ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php echo esc_html( current_time( "mysql" , true ) ); ?></td>
        </tr>
        <tr>
          <th>mysql2date( "G" , current_time( "mysql" ) )</th>
          <td><?php echo esc_html( mysql2date( "G" , current_time( "mysql" ) ) ); ?></td>
        </tr>
        <tr>
          <th>mysql2date( "U" , current_time( "mysql" ) )</th>
          <td><?php echo esc_html( mysql2date( "U" , current_time( "mysql" ) ) ); ?></td>
        </tr>
        <tr>
          <th>mysql2date( get_option( "date_format" ) , current_time( "mysql" ) )</th>
          <td><?php echo esc_html( mysql2date( get_option( "date_format" ) , current_time( "mysql" ) ) ); ?></td>
        </tr>
        <tr>
          <th>mysql2date( get_option( "time_format" ) , current_time( "mysql" ) )</th>
          <td><?php echo esc_html( mysql2date( get_option( "time_format" ) , current_time( "mysql" ) ) ); ?></td>
        </tr>
        <tr>
          <th>mysql2date( "l, F j, Y" , current_time( "mysql" ) )</th>
          <td><?php echo esc_html( mysql2date( "l, F j, Y" , current_time( "mysql" ) ) ); ?></td>
        </tr>
        <tr>
          <th>mysql2date( "l, F j, Y" , current_time( "mysql" ) , false )</th>
          <td><?php echo esc_html( mysql2date( "l, F j, Y" , current_time( "mysql" ) , false ) ); ?></td>
        </tr>
        <tr>
          <th>date_i18n( "Y-m-d H:i:s" )</th>
          <td><?php echo esc_html( date_i18n( "Y-m-d H:i:s" ) ); ?></td>
        </tr>
        <tr>
          <th>date_i18n( "Y-m-d H:i:s" , false )</th>
          <td><?php echo esc_html( date_i18n( "Y-m-d H:i:s" , false ) ); ?></td>
        </tr>
        <tr>
          <th>date_i18n( "Y-m-d H:i:s" , false , true )</th>
          <td><?php echo esc_html( date_i18n( "Y-m-d H:i:s" , false , true ) ); ?></td>
        </tr>
        <tr>
          <th>date_i18n( "Y-m-d H:i:s" , current_time( "timestamp" ) )</th>
          <td><?php echo esc_html( date_i18n( "Y-m-d H:i:s" , current_time( "timestamp" ) ) ); ?></td>
        </tr>
      </tbody>
    </table>
    <p>&nbsp;</p>
